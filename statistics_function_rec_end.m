%% Statistics function
function [results, normalized_results, anova_results, anova_rejected, filtered_ttest, filtered_correlation, results_names] = statistics_function_rec_end(directory,names,channel_selection,time_limit,b_length)
