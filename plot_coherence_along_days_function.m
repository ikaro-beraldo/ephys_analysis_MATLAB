...
for ii = 1:size(names,1)
    for jj = 1:size(names,2)
        ...
        print('-fillpage',fullfile(directory,sprintf('Phase and Spectral Coherence Along the Day - %s',names{ii,jj})),'-dpdf','-vector','-r0',fig_handle)

        saveas(fig_handle,fullfile(directory,sprintf('Phase and Spectral Coherence Along the Day - %s.png',names{ii,jj})))
