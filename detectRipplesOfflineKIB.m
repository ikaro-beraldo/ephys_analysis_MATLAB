function [result] = detectRipplesOfflineKIB(data, samplingRate, plotToMe, notchFilterFreqs, minThresh3rdStep)
...
%               ...         ...        ...       ...
    ...
    for r = 1:nAnimals
        ...
        clearvars -except result r rat data samplingRate...
                          notchFilterFreqs nAnimals plotToMe minThresh3rdStep
        % Notch filter
...
%         thresholdf = 2  ; % Power sd threshold for ripple detection (first stage)
        thresholdf = 3  ; % Power sd threshold for ripple detection (first stage)
